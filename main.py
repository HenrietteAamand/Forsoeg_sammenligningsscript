...
while(counter <=antal_testpersoner):
    ...
    # Dictionary_with_all_observations[str(counter)]["Hr_empatica_" + str(fasenummer)] = maxrefdes103.get_hr()
...
plotter.plot_hr(maxrefdes= Dict_with_obs[counter]['Hr_Maxrefdes103_1'], hrm_pro=Dict_with_obs[counter]['Hr_Hrmpro_1'])
